...
def generate_launch_description():
    ...
    pkg_urdf_path = FindPackageShare('station_description')
    default_rviz_config_path = PathJoinSubstitution([pkg_urdf_path, 'rviz', 'station_description.rviz'])
    ...
    model_arg = DeclareLaunchArgument(
        'model', default_value='exchange_station_whole_description.urdf.xacro',
    ...
    urdf = IncludeLaunchDescription(
        ...
        launch_arguments={
            'urdf_package': 'station_description',
